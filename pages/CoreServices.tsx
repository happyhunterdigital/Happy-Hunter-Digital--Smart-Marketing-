...
export const CoreServices = () => {
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 pt-28">
      
      {/* --- HERO SECTION [cite: 3, 4, 5, 6, 7] --- */}
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto bg-white">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Pillar 1: Trust Anchor [cite: 10, 11, 12, 13] */}
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200 hover:border-yellow-400 hover:shadow-xl transition-all duration-300">
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-400">
                ...
                <p className="text-sm text-gray-700">Inconsistent information, outdated profiles, and poor review management make your business appear unreliable to intelligent systems.</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-xs font-bold text-green-800 uppercase mb-1">Our Solution</p>
                <p className="text-sm text-gray-700"><strong>Your Digital Passport.</strong> We optimize your profiles with real-time updates and precise local signals to prove your business is reliable and worthy of recommendation.</p>
              </div>
            </div>
          </div>

          {/* Pillar 2: AI Megaphone [cite: 14, 15, 16, 17] */}
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200 hover:border-yellow-400 hover:shadow-xl transition-all duration-300">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-xs font-bold text-green-800 uppercase mb-1">Our Solution</p>
                <p className="text-sm text-gray-700"><strong>Citable Content.</strong> We engineer content specifically for entities, ensuring that when systems need answers about your industry, YOU are the source.</p>
              </div>
            </div>
          </div>

          {/* Pillar 3: Conversion Brain [cite: 18, 19, 20, 21] */}
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200 hover:border-yellow-400 hover:shadow-xl transition-all duration-300">
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-400">
                <p className="text-xs font-bold text-red-800 uppercase mb-1">The Challenge</p>
                <p className="text-sm text-gray-700">Small businesses lose customers to competitors because they cannot handle inquiries and bookings 24/7.</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p className="text-xs font-bold text-green-800 uppercase mb-1">Our Solution</p>
      ...
      {/* --- FAILURE POINTS TABLE [cite: 22, 23] --- */}
          ...
          <div className="grid gap-4">
            ...
            <div className="grid md:grid-cols-2 gap-6 p-8 bg-gray-800 rounded-2xl border border-gray-700 hover:bg-gray-750 transition-colors">
              <div>
                ...
                <p className="text-gray-300 leading-relaxed">Your business exists, but intelligent search systems don't recognize it, so they never recommend you to potential customers.</p>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 p-8 bg-gray-800 rounded-2xl border border-gray-700 hover:bg-gray-750 transition-colors">
              <div>
                ...
                <p className="text-gray-300 leading-relaxed">Inconsistent business information and weak reputation signals cause automated systems to filter you out as unreliable.</p>
              </div>
              <div className="border-t md:border-t-0 md:border-l border-gray-700 pt-6 md:pt-0 md:pl-8 flex flex-col justify-center">
                 <div className="flex items-center gap-2 text-yellow-400 font-bold text-lg mb-2">
             ...
             <div className="grid md:grid-cols-2 gap-6 p-8 bg-gray-800 rounded-2xl border border-gray-700 hover:bg-gray-750 transition-colors">
              <div>
                ...
                <p className="text-gray-300 leading-relaxed">Static websites that don't engage visitors or respond to inquiries lose customers to competitors with intelligent, responsive systems.</p>
              </div>
              <div className="border-t md:border-t-0 md:border-l border-gray-700 pt-6 md:pt-0 md:pl-8 flex flex-col justify-center">
                 <div className="flex items-center gap-2 text-yellow-400 font-bold text-lg mb-2">
      ...
      <section className="bg-yellow-400 text-gray-900 py-24 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="mt-6 text-sm font-bold opacity-75 uppercase tracking-wide">Limited Assessments Available for 2026 Strategy</p>
        </div>
      </section>
    </div>
  );
