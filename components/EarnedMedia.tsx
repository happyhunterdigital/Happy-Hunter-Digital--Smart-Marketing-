        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex justify-center mb-8">
            <div className="flex items-center gap-2">
              <div className="bg-yellow-400 text-gray-900 font-black px-3 py-1 text-2xl uppercase tracking-tighter">
                Happy
              </div>
              <div className="border-2 border-yellow-400 text-yellow-400 font-bold px-3 py-1 text-2xl uppercase tracking-tighter">
                Hunter
              </div>
            </div>
          </div>
          ...
          <h1 className="text-4xl md:text-6xl font-black mb-6 tracking-tight">
            Earned Media & <span className="text-yellow-400">Knowledge Base</span>
          </h1>
