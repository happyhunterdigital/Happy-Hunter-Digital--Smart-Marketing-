...
import { initializeApp } from "firebase/app";  // FIXED: was "firebase/firestore"
import { getFirestore } from "firebase/firestore";

const firebaseConfig = {
  apiKey: import.meta.env.VITE_FIREBASE_CONFIG ? JSON.parse(import.meta.env.VITE_FIREBASE_CONFIG).apiKey : "AIzaSyBQvZ2-w9DrJWQEgy4IarClycARAvMJIAc",
...
export const callHunterAI = async (prompt: string) => {
  ...
  if (!KEY) {
    ...
    return "CONFIG_ERROR: API key not configured";
  }
