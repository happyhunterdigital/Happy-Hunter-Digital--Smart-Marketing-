...
import { FaTiktok } from 'react-icons/fa'; // Ensure react-icons is installed
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-16">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
             <Link to="/privacy-policy" className="block text-slate-600 hover:text-slate-400 text-[10px] font-black uppercase tracking-widest">Privacy & POPI Act</Link>
