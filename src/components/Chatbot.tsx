...
export default function Chatbot() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[90]">
      {isOpen ? (
        <div className="w-80 md:w-96 h-[550px] bg-slate-950 border border-slate-800 rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in slide-in-from-bottom-5">
          <div className="p-5 bg-yellow-500 text-slate-950 flex justify-between items-center font-bold shadow-lg">
            <div className="flex flex-col leading-none">
              ...
              <span className="text-[8px] uppercase tracking-widest opacity-80 mt-1 font-black">Smart Marketing</span>
            </div>
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-6">
            ...
            {loading && <div className="text-[10px] text-yellow-500 font-bold animate-pulse uppercase tracking-[0.2em] ml-2">Reasoning...</div>}
            <div ref={scrollRef} />
          </div>
