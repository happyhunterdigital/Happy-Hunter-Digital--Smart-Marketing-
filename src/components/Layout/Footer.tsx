...
// Extracting complex SVG path definitions to clean up the render block
      ...
      <div className="container mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-16">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="https://za.linkedin.com/in/thabomotsumi" target="_blank" rel="noreferrer" className="p-3 bg-[#0a0a0a] rounded-xl text-gray-400 border border-gray-800 hover:text-yellow-500 transition-colors"><Linkedin size={20}/></a>
            <a href="https://x.com/HappyHunter35" target="_blank" rel="noreferrer" className="p-3 bg-[#0a0a0a] rounded-xl text-gray-400 border border-gray-800 hover:text-yellow-500 transition-colors"><XIcon/></a>
            <a href="https://www.instagram.com/happyhunterdigital/" target="_blank" rel="noreferrer" className="p-3 bg-[#0a0a0a] rounded-xl text-gray-400 border border-gray-800 hover:text-yellow-500 transition-colors"><Instagram size={20}/></a>
            <a href="https://www.tiktok.com/@happyhunterdigital" target="_blank" rel="noreferrer" className="p-3 bg-[#0a0a0a] rounded-xl text-gray-400 border border-gray-800 hover:text-yellow-500 transition-colors"><TikTokIcon/></a>
            <a href="https://www.facebook.com/Happyhunterdigital/" target="_blank" rel="noreferrer" className="p-3 bg-[#0a0a0a] rounded-xl text-gray-400 border border-gray-800 hover:text-yellow-500 transition-colors"><Facebook size={20}/></a>
          </div>
        </div>
      </div>
