      ...
      {step === 2 && (
        <div className="max-w-xl mx-auto p-12 border-2 border-slate-800 rounded-[3.5rem] bg-slate-900/40 shadow-2xl animate-in slide-in-from-bottom-5 text-center">
          ...
          <form onSubmit={runAudit} className="space-y-4">
            ...
            <button disabled={loading} className="w-full bg-yellow-500 text-slate-950 py-6 rounded-2xl font-black uppercase shadow-xl hover:bg-white">{loading ? <><Loader2 className="animate-spin" size={20}/> {loadingText}</> : "Initiate Smart Analysis"}</button>
          </form>
        </div>
      )}
      ...
      {step === 3 && (
        <div className="animate-in fade-in">
          <div className="bg-yellow-500 p-10 rounded-[3.5rem] mb-12 text-slate-950 text-center space-y-4 shadow-2xl">
            ...
            <p className="font-bold">Check your email at {formData.email}. Download the master PDF below.</p>
          ...
          <div ref={reportRef} className="p-16 md:p-20 border-2 border-slate-800 rounded-[4rem] bg-slate-900/40 relative shadow-2xl overflow-hidden">
             ...
             <div className="mt-32 p-16 bg-yellow-500 rounded-[3rem] text-slate-950 text-center shadow-2xl">
               ...
               <p className="font-bold text-xl mb-12 italic opacity-90 max-w-xl mx-auto underline decoration-black/20 leading-relaxed text-slate-800">Secure your recovery call with Thabo today.</p>
