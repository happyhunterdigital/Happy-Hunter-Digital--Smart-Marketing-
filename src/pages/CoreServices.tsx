...
import { Target, Globe, Server, Code, ShoppingCart, LayoutTemplate, BrainCircuit, Mail, MapPin, Search, ShieldCheck, Zap, BarChart, ArrowRight, CheckCircle2, ChevronDown, MessageSquareCode, Star } from 'lucide-react';
        ...
        <div className="relative z-10 container mx-auto px-6 text-center max-w-4xl">
          ...
          <div className="flex flex-col items-center justify-center gap-2">
            <div className="flex gap-1 text-yellow-500">
              {[1, 2, 3, 4, 5].map((star) => (
                <Star key={star} className="fill-yellow-500 text-yellow-500" size={16} />
              ))}
            </div>
