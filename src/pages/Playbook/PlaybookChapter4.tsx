      ...
      <div className="container mx-auto px-6 max-w-3xl">
        ...
        <div className="mb-16 border-b border-gray-800 pb-16">
          ...
          <p className="text-gray-300 text-lg leading-relaxed mb-10">
            The lead magnet arms race has been won by the brands offering something more valuable. Consumers demand <b>instant, personalised results</b>.
          </p>
          ...
          <div className="space-y-4 my-12">
            <div className="bg-black border border-gray-800 p-6 rounded-2xl flex items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">The lead magnet collects rich intent data through the completion process instead of just contact details.</p>
              </div>
            </div>
            <div className="bg-black border border-gray-800 p-6 rounded-2xl flex items-start gap-6">
        ...
        <div className="mb-16 border-b border-gray-800 pb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-[#0a0a0a] border border-gray-800 p-8 rounded-3xl text-center">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">Transparency is not a weakness. It is a differentiator.</p>
            </div>
            <div className="bg-[#0a0a0a] border border-gray-800 p-8 rounded-3xl text-center">
        ...
        <div className="mt-20 p-10 bg-gradient-to-br from-[#111827] to-black border border-yellow-500/20 rounded-[3rem] text-center shadow-2xl relative overflow-hidden">
          ...
          <p className="text-gray-400 mb-8 text-base max-w-lg mx-auto leading-relaxed">We help brands implement these strategies without the overwhelm. Let us evaluate where your digital architecture currently stands.</p>
