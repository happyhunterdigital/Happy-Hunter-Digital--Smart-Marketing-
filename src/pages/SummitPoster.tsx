...
import { Download, CheckCircle2, MapPin, Calendar, Percent, BrainCircuit, MonitorSmartphone, ShieldAlert } from 'lucide-react';
...
export const SummitPoster = () => {
  ...
  const downloadPoster = async () => {
    ...
    try {
      ...
      link.download = 'HappyHunter_Summit_Powerhouse_Promo.png';
  ...
  return (
    <div className="min-h-screen bg-[#050505] pt-32 pb-20 flex flex-col items-center justify-center animate-fade-in">
      ...
      <div 
        ref={posterRef}
        className="w-full max-w-[540px] aspect-[4/5] bg-black border-[12px] border-[#111] relative overflow-hidden flex flex-col"
        ...
        <div className="relative z-10 flex flex-col h-full p-10 pt-12">
          ...
          <div className="flex justify-between items-center mb-10">
            <div className="flex items-center gap-3">
              <img src="https://res.cloudinary.com/dka0498ns/image/upload/v1765280886/Happy_Hunter_-Smart_Marketing-_Logo._Digital_Marketing_uupsop.jpg" className="w-10 h-10 rounded-full border-2 border-yellow-500/50" alt="Logo" crossOrigin="anonymous"/>
              <span className="font-handwriting text-3xl text-white lowercase">happyhunterdigital</span>
            </div>
          ...
          {/* Headline Section */}
          <div className="mb-10">
             <p className="text-yellow-500 font-black uppercase tracking-[0.4em] text-[9px] mb-2">Integrated Wellth Summit // Feb 2026</p>
          ...
          <div className="grid grid-cols-2 gap-6 mb-auto">
             <div className="space-y-4">
                ...
                <ul className="space-y-2">
                  <li className="text-gray-300 text-[10px] font-bold uppercase leading-tight">• AI Strategy & Growth</li>
             ...
             <div className="space-y-4 border-l border-gray-800 pl-6">
                <div className="flex items-center gap-2 text-white">
                  <MonitorSmartphone size={16}/><span className="font-black uppercase text-[10px] tracking-widest text-gray-400">Infrastructure</span>
                </div>
                <ul className="space-y-2">
          ...
          <div className="mt-10 pt-6 border-t border-gray-900 flex justify-between items-end">
             ...
             <div className="text-right">
               <p className="text-white font-black text-lg tracking-tighter">HAPPYHUNTERDIGITAL.COM</p>
               <p className="text-yellow-500 text-[7px] font-black uppercase tracking-[0.3em] mt-1">Authorized Agency Partner</p>
             </div>
          </div>

        </div>

        {/* Decorative elements for 'Out of this World' feel */}
        <div className="absolute -bottom-20 -left-20 w-60 h-60 bg-yellow-500/5 blur-[100px] rounded-full"></div>
      </div>
    </div>
  );
};
