...
export const SERVICES_DATA = [
  {
    phase: 1, title: "Entity Architecture", iconType: "Database",
    description: "High-performance Server-Side Rendered (SSR) infrastructure engineered specifically for LLM ingestion.",
    tiers: [
      ...
      { subtitle: "Essential", title: "Agentic Web Hub", priceStart: "R14,000 - R19,000", target: "Established SMEs.", description: "A comprehensive site built so Google and AI tools can easily read your services.", features: ["5-10 hand-coded pages (SSR)", "LocalBusiness Schema", "Expert copywriting"], isPopular: true },
  ...
  },
  {
    ...
    description: "Deploy a 24/7 automated workforce. Capture leads, answer FAQs, and process payments inside the chat.",
    tiers: [
  ...
  },
  {
    ...
    description: "Professional human-led content commands a Human Premium to combat AI slop and establish authority.",
    tiers: [
  ...
  },
  {
    ...
    tiers: [
      ...
      { subtitle: "Essential", title: "AI Voice Agents", priceStart: "R5,000 - R20,000/mo", target: "Automated phone receptionists.", description: "Automated receptionists handling bookings and FAQs over the phone.", features: ["Voice synthesis", "Booking handling"], isPopular: true },
      { subtitle: "Premium", title: "Omnichannel Support", priceStart: "R15k - R50k/mo", target: "Enterprise retainers.", description: "Syncing context across WhatsApp, Web, and Social Media.", features: ["Complex logic updates", "Ongoing training"] }
    ]
  },
  {
            ...
            <div className="grid lg:grid-cols-3 gap-8 items-stretch">
              {phase.tiers.map(tier => (
                <PricingTier 
                  ...
                  icon={ICONS[phase.iconType] || ICONS.Database}
                />
              ))}
            </div>
          </div>
