...
import { Database, BrainCircuit, ShieldCheck, Mic, MessageSquareCode, FileText, CalendarCheck } from 'lucide-react';
...
const ICONS: Record<string, React.ReactNode> = {
  ...
  Mic: <Mic size={32} />,
  MessageSquareCode: <MessageSquareCode size={32} />,
...
export const CoreServices: React.FC = () => {
  return (
    <div className="bg-[#050505] min-h-screen pb-0 animate-fade-in font-sans selection:bg-yellow-500 selection:text-black">
      ...
      {/* RENDER ORIGINAL 5 PHASES */}
      <div className="bg-[#050505]">
        {SERVICES_DATA.map((phase, idx) => (
          <section key={phase.title} className={`py-24 px-6 relative border-b border-gray-900 ${idx % 2 !== 0 ? 'bg-[#020202]' : ''}`}>
            <div className="container mx-auto max-w-7xl">
              <div className="mb-16 text-center">
