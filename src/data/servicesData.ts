...
// 2. NEW MASTER RETAINER TIERS (FROM PDF)
...
export const STANDALONE_SERVICES = [
  ...
  // New GBP & Foundation Services (From PDF)
  { title: "AI Visibility Audit", price: "R3,950", desc: "Full digital entity scan, AI citation analysis, schema gaps." },
  { title: "GBP Setup & Verification", price: "R2,950", desc: "Profile creation, verification, optimization, initial Q&A seeding." },
  { title: "Entity Architecture Starter", price: "R9,950", desc: "1-3 page SSR site, LocalBusiness Schema." },
  { title: "WhatsApp API Setup", price: "R7,950", desc: "API integration, verification, 1 basic flow." },
  { title: "Interactive Lead Magnet", price: "R9,950", desc: "Custom calculator, quiz, or assessment tool." },
  
  // New Growth Retainers (From PDF)
  { title: "GBP Optimization Starter", price: "R1,950 / mo", desc: "Weekly posts, review management, Q&A seeding (5/mo)." },
  { title: "GBP Optimization Pro", price: "R3,950 / mo", desc: "Daily posts, review management, Q&A seeding (15/mo), competitor tracking." },
  { title: "AEO/GEO Starter", price: "R5,950 / mo", desc: "5 AEO articles, GBP Q&A seeding, citation report." },
  { title: "WhatsApp Commerce Pro", price: "R5,950 / mo", desc: "3 flows, catalog management, AI routing." },
  { title: "AI Voice Agent", price: "R9,950 / mo", desc: "Automated phone receptionist, booking integration." },
  { title: "Dynamic Pricing AI", price: "R14,950 / mo", desc: "AI-driven rate management, demand forecasting." }
];
