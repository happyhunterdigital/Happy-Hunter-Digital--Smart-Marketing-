...
// PREMIUM BRAND ASSETS - CUSTOM SVGS
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-yellow-500 selection:text-black pt-12">
      ...
      {/* 1. NEWS TICKER RIBBON */}
      <ContentRibbon />
      
      {/* 2. SUMMIT CAMPAIGN POPUP */}
      <EventPopup />
      ...
      <div className="fixed top-16 left-0 right-0 z-[100] flex justify-center px-4 pointer-events-none">
        <nav className="w-full max-w-5xl bg-black/60 backdrop-blur-xl border border-white/10 rounded-full px-5 py-3 flex justify-between items-center shadow-2xl pointer-events-auto">
          ...
          <Link to="/audit" className="hidden lg:block bg-yellow-500 text-black px-6 py-2.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] hover:bg-white transition-all shadow-xl shadow-yellow-500/20">
            Start Audit
          </Link>
        ...
        <div className="fixed top-32 left-4 right-4 z-[100] bg-black/95 backdrop-blur-2xl border border-gray-800 rounded-3xl p-8 shadow-2xl animate-fade-in lg:hidden">
          <div className="flex flex-col space-y-6 text-center font-bold uppercase tracking-widest text-sm">
            ...
            <div className="pt-4 border-t border-white/10">
              <Link to="/audit" className="inline-block bg-yellow-500 text-black px-8 py-3 rounded-full text-xs font-black w-full">Start Audit</Link>
            </div>
          </div>
        </div>
      )}
      ...
      <footer className="py-24 border-t border-gray-900 bg-black text-left mt-20 px-6">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs">
              Architecting digital dominance for ambitious South African entities. We bridge the gap between financial clarity and digital visibility.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-xs">
              <a href="mailto:motsumitl@happyhunterdigital.com" className="flex items-center gap-3 text-gray-300 hover:text-yellow-500 transition-all font-medium">
                <Mail size={16} className="text-yellow-500"/> motsumitl@happyhunterdigital.com
              </a>
              <a href="https://wa.me/27601016673" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-gray-300 hover:text-yellow-500 transition-all font-medium">
                <Phone size={16} className="text-yellow-500"/> +27 (0) 60 101 6673
              </a>
              <a href="https://www.happyhunterdigital.com" className="flex items-center gap-3 text-gray-300 hover:text-yellow-500 transition-all font-medium">
                <Globe size={16} className="text-yellow-500"/> www.happyhunterdigital.com
              </a>
            </div>
          </div>

          {/* Column 3: Internal Hubs */}
          <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4">
              <a href="https://za.linkedin.com/in/thabomotsumi" target="_blank" rel="noreferrer" className="p-3 bg-[#0a0a0a] rounded-xl text-gray-400 hover:text-yellow-500 hover:border-yellow-500 border border-gray-800 transition-all shadow-lg">
                <Linkedin size={20}/>
              </a>
              <a href="https://x.com/HappyHunter35" target="_blank" rel="noreferrer" className="p-3 bg-[#0a0a0a] rounded-xl text-gray-400 hover:text-yellow-500 hover:border-yellow-500 border border-gray-800 transition-all shadow-lg">
                <XIcon/>
              </a>
              <a href="https://www.instagram.com/happyhunterdigital/" target="_blank" rel="noreferrer" className="p-3 bg-[#0a0a0a] rounded-xl text-gray-400 hover:text-yellow-500 hover:border-yellow-500 border border-gray-800 transition-all shadow-lg">
                <Instagram size={20}/>
              </a>
              <a href="https://www.tiktok.com/@happyhunterdigital" target="_blank" rel="noreferrer" className="p-3 bg-[#0a0a0a] rounded-xl text-gray-400 hover:text-yellow-500 hover:border-yellow-500 border border-gray-800 transition-all shadow-lg">
                <TikTokIcon/>
              </a>
              <a href="https://www.facebook.com/Happyhunterdigital/" target="_blank" rel="noreferrer" className="p-3 bg-[#0a0a0a] rounded-xl text-gray-400 hover:text-yellow-500 hover:border-yellow-500 border border-gray-800 transition-all shadow-lg">
                <Facebook size={20}/>
              </a>
            </div>
          </div>
        ...
        <div className="container mx-auto mt-24 border-t border-gray-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
           <p className="text-gray-800 text-[9px] font-black uppercase tracking-[0.5em] opacity-40">
           ...
           <div className="flex gap-6 text-[8px] font-bold uppercase tracking-widest text-gray-600">
             ...
             <Link to="/faq" className="hover:text-white">Terms of Deployment</Link>
           </div>
        </div>
      </footer>
