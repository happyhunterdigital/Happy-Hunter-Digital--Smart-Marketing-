...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-yellow-500 selection:text-black pt-10">
      ...
      {/* MOBILE MENU */}
      {menuOpen && (
        <div className="fixed top-28 left-4 right-4 z-[100] bg-black/95 backdrop-blur-2xl border border-gray-800 rounded-3xl p-8 shadow-2xl animate-fade-in lg:hidden">
      ...
      <footer className="py-24 border-t border-gray-900 bg-black text-left">
        <div className="container mx-auto px-6 grid md:grid-cols-2 lg:grid-cols-4 gap-16">
          <div className="space-y-6">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">Architecting digital dominance for ambitious South African entities. Bridging financial clarity with market visibility.</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4 text-xs font-bold uppercase tracking-widest text-gray-400">
              <Link to="/services" className="hover:text-yellow-500">The Protocol</Link>
              <Link to="/earned-media" className="hover:text-yellow-500">Success Nodes</Link>
              <Link to="/blog" className="hover:text-yellow-500">Intelligence Hub</Link>
            </div>
          </div>
