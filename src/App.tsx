      ...
      <div className="fixed top-16 left-0 right-0 z-[100] flex justify-center px-4 pointer-events-none">
        <nav className="w-full max-w-5xl bg-black/60 backdrop-blur-xl border border-white/10 rounded-full px-5 py-3 flex justify-between items-center shadow-2xl pointer-events-auto">
          <Link to="/" className="flex items-center gap-3 pl-2">
            ...
            <span className="font-handwriting text-3xl text-white">happyhunterdigital</span>
          </Link>
          ...
          <Link to="/audit" className="hidden lg:block bg-yellow-500 text-black px-6 py-2.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] hover:bg-white transition-all">Start Audit</Link>
      ...
      <footer className="py-24 border-t border-gray-900 bg-black text-left mt-20 px-6">
        <div className="container mx-auto grid md:grid-cols-4 gap-16">
          <div className="space-y-6">
            <span className="font-handwriting text-3xl lowercase text-white">happyhunterdigital</span>
            <p className="text-gray-500 text-sm">Architecting digital dominance for ambitious South African entities.</p>
          </div>
          <div className="space-y-6">
            <h3 className="text-[10px] font-black uppercase tracking-widest text-gray-500 border-b border-gray-900 pb-4">Direct Lines</h3>
          ...
          <div className="space-y-6">
            <h3 className="text-[10px] font-black uppercase tracking-widest text-gray-500 border-b border-gray-900 pb-4">Internal Hubs</h3>
          ...
          <div className="space-y-6">
            <h3 className="text-[10px] font-black uppercase tracking-widest text-gray-500 border-b border-gray-900 pb-4">Social Signals</h3>
            <div className="flex flex-wrap gap-4">
              <a href="https://za.linkedin.com/in/thabomotsumi" className="p-3 bg-gray-900 rounded-xl text-gray-400 hover:text-yellow-500 border border-gray-800 transition-all shadow-lg"><Linkedin size={20}/></a>
              <a href="https://x.com/HappyHunter35" className="p-3 bg-gray-900 rounded-xl text-gray-400 hover:text-yellow-500 border border-gray-800 transition-all shadow-lg"><XIcon/></a>
              <a href="https://www.tiktok.com/@happyhunterdigital" className="p-3 bg-gray-900 rounded-xl text-gray-400 hover:text-yellow-500 border border-gray-800 transition-all shadow-lg"><TikTokIcon/></a>
            </div>
          </div>
        </div>
        <p className="text-center text-[9px] font-black uppercase tracking-[0.5em] text-gray-800 mt-24 border-t border-gray-900 pt-8 opacity-40">&copy; 2026 // HAPPYHUNTERDIGITAL SYSTEMS</p>
      </footer>
      <Chatbot />
      <CookieConsent />
    </div>
