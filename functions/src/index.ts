...
export const performAudit = onCall({
    ...
    // Firebase automatically loads these from the .env file generated by GitHub Actions
    ...
    try {
        ...
        // FIXED: Using the correct model endpoint 'gemini-1.5-flash' instead of 'gemini-flash-latest'
        ...
        if (!aiData.candidates || !aiData.candidates[0].content?.parts[0]?.text) {
            ...
            try {
                ...
                // FIXED: Strip markdown formatting injected by LLM before parsing
...
export const hunterChat = onCall({
    ...
    try {
        // FIXED: Using correct model endpoint here as well
        const aiRes = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${G_KEY}`, {
