...
// ============================================================================
// UPDATED: Using the precise technical identifier for the Flash-Lite 2.0 architecture 
// to prevent the 404 API error while strictly maintaining the Lite-model performance.
